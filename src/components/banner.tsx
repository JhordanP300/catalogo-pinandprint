		...
		<div id="personalizar" className="banner bg-moradoPrint border-t-[3px] border-b-[3px] border-negroPrint py-16 px-8 text-center relative overflow-hidden">
			<div className="relative z-1 max-w-175 mx-auto">
				...
				<p className="font-['AmberlySans'] text-[1rem] text-blancoPrint opacity-90 mb-8 leading-[1.6]">
					Mandanos tu idea, diseño o concepto y lo convertimos en una camisa única hecha especialmente para ti. 
				</p>

				<div className="flex gap-4 justify-center flex-wrap">
					<a
						href="/CATALOGO CAMISAS 2026.pdf" target="_blank"
